...
void hgeAnimation::ResetFrames(float x1,float y1,float w,float h,int nframes,float FPS,bool searchDown)
{
	hgeSprite::SetTextureRect(x1,y1,w,h);
	fSinceLastFrame=-1.0f;
	fSpeed=1.0f/FPS;
	nFrames=nframes;
	bSearchDown = searchDown;
