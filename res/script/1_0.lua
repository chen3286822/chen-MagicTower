...
--scene:PushAction(ID_Zhangliao,eAction_Walk,eDir_Right,0,4)
--local num = scene:GetCurrentNum()
--scene:PushAction(ID_Caocao,eAction_Shout,eDir_Left,200,0,num)
--scene:PushAction(ID_Yujin,eAction_Cry,eDir_Down,400,0,num)
--scene:PushWords(1,"曹操","哈哈哈哈")
--scene:PushWords(1,"曹操","这就是我的计划，怎么样？你们愿意接受吗？")
--scene:PushAction(ID_Zhangliao,eAction_Walk,eDir_Left,0,4)
--scene:PushWords(11,"于禁","不，我绝不接受！")
